...
-- This example assumes merchants are created and linked to auth.users via merchants.id
...
-----------------------------
-- insert into merchants (id, id, name, phone) values (gen_random_uuid(), '00000000-0000-0000-0000-000000000000', 'Demo Merchant', '+27123456789');
